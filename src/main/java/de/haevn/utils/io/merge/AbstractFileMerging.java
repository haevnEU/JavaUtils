 ...
 */
public abstract class AbstractFileMerging {
     ...
     */
    public abstract void mergeFiles(final File output, final List<File> input) throws IOException;
     ...
     * @throws IOException if an error occurs while merging the files
     */
    public void mergeFiles(File output, String... input) throws IOException {
     ...
     * @throws IOException if an error occurs while merging the files
     */
    public void mergeFiles(File output, File... input) throws IOException {
